  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-lg text-sm font-medium transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        code: "bg-lovable-chat-bg text-white hover:bg-white/20 border border-white/20 hover:border-white/40 transition-all duration-200",
        ...
        lovable: "bg-lovable-chat-bg text-white hover:bg-white/20 border border-white/20 hover:border-white/40 transition-all duration-200",
        lovablePrimary: "bg-orange-500 text-white hover:bg-orange-600 border border-orange-400 hover:border-orange-300 transition-all duration-200",
      },
      size: {
